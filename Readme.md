...
# Parsing + Configuration Script – AP - GC Diafragma NB - Rev. A

This **Parsing + Configuration** script is designed for the **AP - GC Diafragma NB** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AP - GC Diafragma NB Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AP - GC Diafragma NB** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
